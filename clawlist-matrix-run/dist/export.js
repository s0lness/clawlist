import { createClient, getMessages } from './matrix-api.js';
import { loadDmRoomMeta } from './dm-room.js';
import { log } from './common.js';
import { writeFile, mkdir } from 'node:fs/promises';
import { join } from 'node:path';
/** Export room messages to JSONL */
async function exportRoom(homeserver, accessToken, roomId, outputPath, limit = 1000) {
...
export async function exportRun(homeserver, marketRoomId, sellerToken, outDir, marketMessageLimit = 500, dmMessageLimit = 200) {
